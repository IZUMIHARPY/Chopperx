...
!function(t, e) {
    ...
    function D(t, e) {
        ...
        t.clearTimeoutFn = I.bind(P)) : (t.setTimeoutFn = setTimeout.bind(P),
    ...
    var Ot = function() {
        ...
        return r(t, [{
            key: "encode",
            value: function(t) {
                return t.type !== Et.EVENT && t.type !== Et.ACK || !mt(t) ? [this.encodeAsString(t)] : (t.type = t.type === Et.EVENT ? Et.BINARY_EVENT : Et.BINARY_ACK,
        ...
        return r(a, [{
            ...
            value: function(t) {
                ...
                if ("string" == typeof t) {
                    ...
                    (e = this.decodeString(t)).type === Et.BINARY_EVENT || e.type === Et.BINARY_ACK ? (this.reconstructor = new Rt(e),
